...
public class MSB_HVE_1 : StateMachineBehaviour
{
    ...
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if (_playerMain == null)
        {
            ...
            damageData = _playerMain._combatSystem.weaknessDatas[weaknessIndex];
        }
    ...
    private void CustomFunction(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        */
        ...
        {
            _playerMain._combatSystem.SetHurtboxDamageMultiplier(damageIndex, i, damageData.damageTypes[i].Value); // Example: set damage multiplier for hurtbox index 0
        }
        // other function
        // vfx
        // sfx
